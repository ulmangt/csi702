...
filter_serial: filter_math.o filter_serial.o
	gcc -I hdr -lm src/serial/filter_serial.o src/common/filter_math.o -o bin/filter_serial
...
clean:
	rm bin/filter_serial src/serial/filter_serial.o src/common/filter_math.o
