...
Unfortunately, as indicated by Figure \ref{profiler1}, this approach is very slow on GPU hardware because of the large ammount of uncoalesed memory access which it must perform.
